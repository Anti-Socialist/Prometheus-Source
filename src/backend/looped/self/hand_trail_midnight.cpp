...
namespace big
{
    void looped::hand_trail_midnight()
    {
        if (g.self.hand_trail_midnight)
        {
            ...
            if (STREAMING::HAS_NAMED_PTFX_ASSET_LOADED("scr_rcpaparazzo1"))
            {
                ...
                GRAPHICS::SET_PARTICLE_FX_NON_LOOPED_COLOUR(0, 14, 52);
                ...
                GRAPHICS::SET_PARTICLE_FX_NON_LOOPED_COLOUR(10, 34, 52);
                GRAPHICS::SET_PARTICLE_FX_NON_LOOPED_ALPHA(1.0f);
            }
        }
    }
