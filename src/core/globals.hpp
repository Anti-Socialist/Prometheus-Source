			...
			struct logs
			{
				...
				struct script_event
				{
					...
					struct tunables
					{
						...
						NLOHMANN_DEFINE_TYPE_INTRUSIVE(tunables, disable_phone, no_idle_kick, remove_speed_limit)
					} tunables{};
							...
							struct player_join
							{
								...
								struct reactions
								{
									...
									NLOHMANN_DEFINE_TYPE_INTRUSIVE(reactions, bounty, ceo_money, ceo_kick, clear_wanted_level, crash, end_session_kick, fake_deposit, force_mission, force_teleport, gta_banner, kick_from_interior, mc_teleport, network_bail, personal_vehicle_destroyed,
										remote_off_radar, rotate_cam, send_to_cutscene, send_to_location, sound_spam, spectate_notification, give_collectible, transaction_error, tse_freeze, tse_sender_mismatch, vehicle_kick, teleport_to_warehouse, start_activity, start_script,
										null_function_kick, destroy_personal_vehicle, clear_ped_tasks, turn_into_beast, remote_wanted_level, trigger_business_raid, remote_wanted_level_others, remote_ragdoll, kick_vote, report_cash_spawn, modder_detection, request_control_event, report,
										...
										struct protections
										{
											struct script_events
											{
												...
												struct self
												{
													...
													bool auto_tp = false;
													bool money_drop = false;
													bool collectable_drop = false;
													bool hand_trail_red = false;
													bool hand_trail_green = false;
													bool hand_trail_blue = false;
													bool hand_trail_midnight = false;
													bool hand_trail_magenta = false;
													bool aimbot = false;
													bool aimbot_exclude_friend = false;
													bool fire_breath = false;
													bool magnet_gun = false;
													bool container_rider = false;
													bool move_water = false;
													bool money_gun = false;
													bool tiny_player = false;
													bool high_effect = false;
													bool air_swim = false;
													bool walk_on_water = false;
													bool water_loop = false;
													bool fire_loop = false;
													bool force_field = false;
													bool super_man = false;
													bool beast_jump = false;
													bool money_loop = false;
													bool nightclub_loop = false;
													bool ride_deer = false;
													bool sync_fuzzer = false;

													// do not save below entries
													bool dance_mode = false;
													bool flying_axe = false;
													...
													NLOHMANN_DEFINE_TYPE_INTRUSIVE(self,
														...
														force_show_hud, mobile_radio, fast_respawn, auto_tp, aimbot, aimbot_exclude_friend, beast_jump, super_man,
														aimbot, aimbot_exclude_friend, hand_trail_red, hand_trail_green, hand_trail_blue, hand_trail_magenta)
												} self{};
													...
													struct session
													{
														...
														bool delete_vehicles = false;
														bool burst_vehicle_tires = false;
														bool launch_vehicles = false;
														bool horn_vehicles = false;
														bool repair_vehicles = false;
														bool upgrade_vehicles = false;
														bool explode_peds = false;
														bool rain_rockets = false;
														bool asteroid_shower = false;
														...
														struct settings
														{
															struct hotkeys
															{
																...
																NLOHMANN_DEFINE_TYPE_INTRUSIVE(hotkeys, editing_menu_toggle, menu_toggle, teleport_waypoint, teleport_objective, suicide, noclip, bringvehicle, invis, heal, fill_inventory, skip_cutscene, freecam, superrun, superjump, beastjump, invisveh, localinvisveh)
															} hotkeys{};
																					...
																					struct speedo_meter
																					{
																						...
																						struct fly
																						{
																							...
																							struct rainbow_paint
																							{
																								...
																								bool vehicle_trail = false;
																								bool vehicle_invisible = false;
																								bool local_vehicle_invisible = false;
																								...
																								NLOHMANN_DEFINE_TYPE_INTRUSIVE(vehicle,
																									...
																									keep_vehicle_repaired, no_water_collision, disable_engine_auto_start, change_engine_state_immediately, drift_mode)
																				} vehicle{};
																								...
																								struct weapons
																								{
																									struct ammo_special
																									{
																										...
																										bool paint_gun = false;
																										bool valkery_gun = false;
																										bool flame_thrower = false;
																										bool fly_gun = false;
																										bool rope_gun = false;
																										bool collectable_gun = false;
																										...
																										struct console_log {
																											bool opened = false;
                                                                                                            NLOHMANN_DEFINE_TYPE_INTRUSIVE(console_log, opened)
																										} console_log{};

																											NLOHMANN_DEFINE_TYPE_INTRUSIVE(window, color, gui_scale, switched_view, ingame_overlay, console_log)
																										} window{};
																															...
																															struct stat_editor
		{
			...
			NLOHMANN_DEFINE_TYPE_INTRUSIVE(stat_editor, stat, packed_stat)
																															...
																															NLOHMANN_DEFINE_TYPE_INTRUSIVE(menu_settings,
																																...
																																spawn_ped, spoofing, vehicle, weapons, window, context_menu, esp, session_browser, ugc, reactions, stat_editor)
	};
